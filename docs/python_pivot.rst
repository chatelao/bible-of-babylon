...
.. list-table:: Python Pivot Table
   ...
   * - CollectionDefinition
     - .. code-block:: python
           ...
           l = [1, 2, 3]
     - Lists are the primary collection type in Python.
   * - AssociativeArrayDefinition
     - .. code-block:: python

           d = {"a": 1, "b": 2}
     - Dictionaries are Python's native associative array type.
   * - IfElse
     - .. code-block:: python
   ...
   * - MutexDefinition
     - .. code-block:: python
           ...
           lock = threading.Lock()
     - Part of the threading module.
   * - MutexLock
     - .. code-block:: python

           lock.acquire()
     - Can be used as a context manager: with lock:
   * - MutexUnlock
     - .. code-block:: python
   ...
   * - SemaphoreDefinition
     ...
     - Initial value sets the number of concurrent permits.
   * - SemaphoreWait
     - .. code-block:: python
   ...
   * - ForEach
     - .. code-block:: python
           ...
           for item in collection:
               # body
     - Python's standard for loop is naturally a for-each loop.
   * - LogicalAnd
     - .. code-block:: python
   ...
   * - LogicalXor
     - .. code-block:: python
           ...
           a != b
     - Python uses != for logical XOR between booleans.
   * - Equal
     - .. code-block:: python
